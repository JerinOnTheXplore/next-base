      ...
      <div className="max-w-7xl mx-auto px-8 sm:px-12 lg:px-16 py-5 ">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex space-x-6 items-center">
            <Link href="/" className="hover:text-blue-500 transition font-bold">Home</Link>
            <Link href="/products" className="hover:text-blue-500 transition font-bold">Products</Link>
